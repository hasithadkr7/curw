...
load_config_operator = PythonOperator(task_id='load_config', python_callable=load_config, dag=dag)
...
load_config_operator >> rft_to_csv_operator >> csv_to_dss_operator >> update_hec_hms_model_operator >> run_hec_hms_model_operator
